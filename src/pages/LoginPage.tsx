    ...
    <div className="shell">
      <div className="login-wrap">
        <div className="login-topbar">
          {step === 'roles' ? (
            <button type="button" className="admin-link-corner" onClick={openAdmin}>
              Administración
            </button>
          ) : (
            <span />
        ...
        <CollegeBanner onLogoClick={resetToHome} />
        ...
        {step === 'auth' && role && (
          <section className="glass-panel validation-panel">
            ...
            <form className="stack-form" onSubmit={onSubmit}>
              ...
              <button type="button" className="link-back" onClick={resetToHome}>
                ← Volver al inicio
              </button>
            </form>
          </section>
